...
import { WrapperCircuito } from './styles/wrapperCircuito';
export function Circuito() {
  return (
  <WrapperCircuito>
<svg width="2400px" height="1600px" viewBox="0 0 2400 1600" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink">
  <defs>
  ...
  <g id="module-01" transform="translate(-1.000000, 0.000000)" className="path path-01" stroke="url(#linear)" strokeWidth="4" fill="none" fillRule="evenodd" strokeLinecap="butt" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="8,960,24,960,16,400" strokeDashoffset="6400">
  ...
  <g id="module-02" transform="translate(599.000000, 0.000000)" className="path path-02" stroke="url(#linear)" strokeWidth="4" fill="none" fillRule="evenodd" strokeLinecap="butt" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="8,960,24,960,16,400" strokeDashoffset="6400">
  ...
  <g id="module-03" transform="translate(1024.000000, 164.000000)" className="path path-03" stroke="url(#linear)" strokeWidth="4" fill="none" fillRule="evenodd" strokeLinecap="butt" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="8,960,24,960,16,400" strokeDashoffset="6400">
  ...
  <g id="module-04" transform="translate(1532.000000, 115.000000)" className="path path-04" stroke="url(#linear)" strokeWidth="4" fill="none" fillRule="evenodd" strokeLinecap="butt" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="8,960,24,960,16,400" strokeDashoffset="6400">
    <g id="C19">
  ...
  <g id="module-05" transform="translate(1908.000000, 0.000000)" className="path path-05" stroke="url(#linear)" strokeWidth="4" fill="none" fillRule="evenodd" strokeLinecap="butt" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="8,960,24,960,16,400" strokeDashoffset="6400">
    <g id="C13">
      <polyline points="272 196 288 196 300 208 300 224 324 248 416 248 421 243 428 243"></polyline>
      <polyline points="272 188 292 188 308 204 308 220 328 240 412.005952 240 420.002977 232.002976 480 232.002976 493.001488 219.001488 494 218 494 171"></polyline>
      <path d="M272,180 L284,180"></path>
