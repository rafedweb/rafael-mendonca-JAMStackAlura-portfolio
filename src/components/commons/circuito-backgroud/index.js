...
import { WrapperCircuitoBackgroud } from './Styles/wrapperCircuitoBackgroud';
export function CircuitoBackgroud() {
  return (
      <WrapperCircuitoBackgroud>
<svg width="800px" height="800px" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink">
  <g id="paths" className="path" stroke="#FFAE0C" strokeWidth="2" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="30,150" strokeDashoffset="2000">
  ...
  <g id="paths-2" className="path-2" stroke="#FFAE0C" strokeWidth="3" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeOpacity="1" strokeDasharray="50,150" strokeDashoffset="2000">
